...
GlassWindow::GlassWindow(jobject jrefThis, bool isTransparent, bool isDecorated, bool isUnified, bool isExtended, bool isAppBar, AppBarBorder appBarBorder, HWND parentOrOwner)
